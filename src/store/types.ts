...
export class SettingState {
   ...
   * 字体
   */
  fontFamily = '"霞鹜文楷 GB","霞鹜文楷 GB 屏幕阅读版","霞鹜文楷 GB 屏幕阅读版 常规","PingFang SC","思源黑体 CN","思源黑体", "Microsoft YaHei","Source Han Sans SC","Noto Sans CJK SC","WenQuanYi Micro Hei",sans-serif,SimSun,Simsum-ExtB,Simsun-ExtG,TH-Sung-TP2,TH-Sung-TP0'
  /**
   * 字号
   */
  fontSize = '3rem'
